...
//    let url = `https://localhost:8000/api/Tasks/subtasks?taskId=${taskId}`;
//    let method = "POST"

//    if (isUpdating) {
//        url = `https://localhost:8000/api/SubTasks/${subtaskId}`;
//        method = "PUT";
//    }
...
//    document.getElementById('addOrUpdateSubTask').addEventListener('click', function () {
//        saveOrUpdateSubTask();
//    });
...
//                    if (deleteButton) {
//                        event.preventDefault();
//                        subtaskId = deleteButton.dataset.subtaskId;
//                        handleDeleteConfirmation(subtaskId, 'SubTasks');
//                    }
//                })
//            }
